...
| 30 KWD | Legacy single item (100ml) | The Finest ("Bulgarian Roses and Oud") — distinct product from The Finest Everyday; near-stockout at 2 units, likely phase-out (see Operational Flags) |
...
2. **The Finest at 2 units** — 30 KWD, "Bulgarian Roses and Oud", distinct from The Finest Everyday (35 KWD) and previously missing from the Price Architecture table above (now added); near stockout on a named favorite, confirm restock or intended phase-out.
3. **Low stock:** N.8 Remix (41), N.33 Remix (86).
